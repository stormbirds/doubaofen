...
class SubscriberMethodFinder {
    ...
    private List<SubscriberMethod> findSubscriberMethodsWithIndex(Class<?> cls) {
        ...
        while (cls2 != null) {
            SubscriberMethod[] subscribersFor = INDEX.getSubscribersFor(cls2);
            if (subscribersFor == null || subscribersFor.length <= 0) {
                ...
                for (SubscriberMethod add : subscribersFor) {
                    arrayList.add(add);
                }
                return arrayList;
            }
                    ...
                    if (parameterTypes.length == 1) {
                        ...
                        if (subscribe != null) {
                            ...
                            if (hashSet.add(sb.toString())) {
                                SubscriberMethod subscriberMethod = r10;
                                SubscriberMethod subscriberMethod2 = new SubscriberMethod(method, cls3, subscribe.threadMode(), subscribe.priority(), subscribe.sticky());
