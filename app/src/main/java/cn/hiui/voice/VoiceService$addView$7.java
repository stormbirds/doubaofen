...
final class VoiceService$addView$7 implements View.OnClickListener {
    ...
    VoiceService$addView$7(VoiceService voiceService, ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, TextView textView, TextView textView2, EditText editText) {
    ...
    public final void onClick(View view) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(textView, "tab1");
        Sdk25PropertiesKt.setTextColor(textView, -1);
        TextView textView2 = this.$tab2;
        Intrinsics.checkExpressionValueIsNotNull(textView2, "tab2");
        ...
        voiceService.loadFileList(editText.getText().toString());
    }
}
