...
final class VoiceService$onWxSend$1 extends Lambda implements Function1<Context, Unit> {
    public static final VoiceService$onWxSend$1 INSTANCE = new VoiceService$onWxSend$1();

    VoiceService$onWxSend$1() {
        super(1);
    }
