...
public final class SqlTypesKt {
    ...
    private static final SqlType BLOB = new SqlTypeImpl("BLOB", (String) null, 2, (DefaultConstructorMarker) null);
    private static final SqlType INTEGER = new SqlTypeImpl("INTEGER", (String) null, 2, (DefaultConstructorMarker) null);
    private static final SqlTypeModifier NOT_NULL = new SqlTypeModifierImpl("NOT NULL");
    private static final SqlType NULL = new SqlTypeImpl("NULL", (String) null, 2, (DefaultConstructorMarker) null);
    private static final SqlTypeModifier PRIMARY_KEY = new SqlTypeModifierImpl("PRIMARY KEY");
    private static final SqlType REAL = new SqlTypeImpl("REAL", (String) null, 2, (DefaultConstructorMarker) null);
    private static final SqlType TEXT = new SqlTypeImpl("TEXT", (String) null, 2, (DefaultConstructorMarker) null);
    ...
    public static final Pair<String, SqlType> FOREIGN_KEY(String str, String str2, String str3, SqlTypeModifier... sqlTypeModifierArr) {
        ...
        sb.append(str3);
        sb.append(")");
        Object[] objArr = (Object[]) sqlTypeModifierArr;
        Collection arrayList = new ArrayList(objArr.length);
        for (Object obj : objArr) {
            arrayList.add(((SqlTypeModifier) obj).getModifier());
        }
        sb.append(CollectionsKt.joinToString$default((List) arrayList, "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, SqlTypesKt$FOREIGN_KEY$2.INSTANCE, 30, (Object) null));
        return TuplesKt.to("", new SqlTypeImpl(sb.toString(), (String) null, 2, (DefaultConstructorMarker) null));
    }
