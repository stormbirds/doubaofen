...
final class C$$Anko$Factories$Sdk25View$PROGRESS_BAR$1 extends Lambda implements Function1<Context, ProgressBar> {
    public static final C$$Anko$Factories$Sdk25View$PROGRESS_BAR$1 INSTANCE = new C$$Anko$Factories$Sdk25View$PROGRESS_BAR$1();

    C$$Anko$Factories$Sdk25View$PROGRESS_BAR$1() {
        super(1);
    }
