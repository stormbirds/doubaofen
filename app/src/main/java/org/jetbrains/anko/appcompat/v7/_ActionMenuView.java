...
public class _ActionMenuView extends ActionMenuView {
    ...
    public final <T extends View> T lparams(T t, Context context, AttributeSet attributeSet, Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
    ...
    public final <T extends View> T lparams(T t, ViewGroup.LayoutParams layoutParams, Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, ActionMenuView.LayoutParams layoutParams, Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ActionMenuView _actionmenuview, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, Function1<? super ActionMenuView.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        ActionMenuView.LayoutParams layoutParams = new ActionMenuView.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ActionMenuView _actionmenuview, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
