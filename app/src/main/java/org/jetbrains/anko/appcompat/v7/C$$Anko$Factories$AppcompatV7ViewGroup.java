...
public final class C$$Anko$Factories$AppcompatV7ViewGroup {
    ...
    private C$$Anko$Factories$AppcompatV7ViewGroup() {
        INSTANCE = this;
        LIST_MENU_ITEM_VIEW = C$$Anko$Factories$AppcompatV7ViewGroup$LIST_MENU_ITEM_VIEW$1.INSTANCE;
        ACTION_BAR_CONTAINER = C$$Anko$Factories$AppcompatV7ViewGroup$ACTION_BAR_CONTAINER$1.INSTANCE;
        ACTION_BAR_OVERLAY_LAYOUT = C$$Anko$Factories$AppcompatV7ViewGroup$ACTION_BAR_OVERLAY_LAYOUT$1.INSTANCE;
        ACTION_MENU_VIEW = C$$Anko$Factories$AppcompatV7ViewGroup$ACTION_MENU_VIEW$1.INSTANCE;
        ALERT_DIALOG_LAYOUT = C$$Anko$Factories$AppcompatV7ViewGroup$ALERT_DIALOG_LAYOUT$1.INSTANCE;
        BUTTON_BAR_LAYOUT = C$$Anko$Factories$AppcompatV7ViewGroup$BUTTON_BAR_LAYOUT$1.INSTANCE;
        LINEAR_LAYOUT_COMPAT = C$$Anko$Factories$AppcompatV7ViewGroup$LINEAR_LAYOUT_COMPAT$1.INSTANCE;
        LIST_VIEW_COMPAT = C$$Anko$Factories$AppcompatV7ViewGroup$LIST_VIEW_COMPAT$1.INSTANCE;
        SCROLLING_TAB_CONTAINER_VIEW = C$$Anko$Factories$AppcompatV7ViewGroup$SCROLLING_TAB_CONTAINER_VIEW$1.INSTANCE;
    ...
    public final Function1<Context, _ListViewCompat> getLIST_VIEW_COMPAT() {
