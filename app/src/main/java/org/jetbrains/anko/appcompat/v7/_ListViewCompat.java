...
public class _ListViewCompat extends ListViewCompat {
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ListViewCompat _listviewcompat, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ListViewCompat _listviewcompat, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ListViewCompat _listviewcompat, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ListViewCompat _listviewcompat, View view, int i, int i2, int i3, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                i = -2;
            }
