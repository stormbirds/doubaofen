...
public class _ScrollingTabContainerView extends ScrollingTabContainerView {
    ...
    public final <T extends View> T lparams(T t, Context context, AttributeSet attributeSet, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ScrollingTabContainerView _scrollingtabcontainerview, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ScrollingTabContainerView _scrollingtabcontainerview, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ScrollingTabContainerView _scrollingtabcontainerview, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, int i3, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(i, i2, i3);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ScrollingTabContainerView _scrollingtabcontainerview, View view, int i, int i2, int i3, int i4, Object obj) {
        if (obj == null) {
            if ((i4 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, ViewGroup.LayoutParams layoutParams, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, ViewGroup.MarginLayoutParams marginLayoutParams, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, FrameLayout.LayoutParams layoutParams, Function1<? super FrameLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
