...
public class _ButtonBarLayout extends ButtonBarLayout {
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ButtonBarLayout _buttonbarlayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ButtonBarLayout _buttonbarlayout, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ButtonBarLayout _buttonbarlayout, View view, int i, int i2, float f, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_ButtonBarLayout _buttonbarlayout, View view, int i, int i2, float f, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
