...
public class _SlidingPaneLayout extends SlidingPaneLayout {
    ...
    public final <T extends View> T lparams(T t, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_SlidingPaneLayout _slidingpanelayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        SlidingPaneLayout.LayoutParams layoutParams = new SlidingPaneLayout.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_SlidingPaneLayout _slidingpanelayout, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, ViewGroup.LayoutParams layoutParams, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, ViewGroup.MarginLayoutParams marginLayoutParams, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, SlidingPaneLayout.LayoutParams layoutParams, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
    ...
    public final <T extends View> T lparams(T t, SlidingPaneLayout.LayoutParams layoutParams) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        if (layoutParams == null) {
            Intrinsics.throwNpe();
        }
    ...
    public final <T extends View> T lparams(T t, Context context, AttributeSet attributeSet, Function1<? super SlidingPaneLayout.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        if (context == null) {
            Intrinsics.throwNpe();
