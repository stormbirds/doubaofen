...
public class _RadioGroup extends RadioGroup {
    ...
    public final <T extends View> T lparams(T t, Context context, AttributeSet attributeSet, Function1<? super RadioGroup.LayoutParams, Unit> function1) {
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(i, i2);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, float f, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, int i, int i2, float f, Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        RadioGroup.LayoutParams layoutParams = new RadioGroup.LayoutParams(i, i2, f);
        function1.invoke(layoutParams);
    ...
    public static /* bridge */ /* synthetic */ View lparams$default(_RadioGroup _radiogroup, View view, int i, int i2, float f, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                i = -2;
            }
    ...
    public final <T extends View> T lparams(T t, ViewGroup.LayoutParams layoutParams, Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
    ...
    public final <T extends View> T lparams(T t, ViewGroup.MarginLayoutParams marginLayoutParams, Function1<? super RadioGroup.LayoutParams, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(t, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
