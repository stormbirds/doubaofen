...
final class C$$Anko$Factories$Sdk25ViewGroup$IMAGE_SWITCHER$1 extends Lambda implements Function1<Context, _ImageSwitcher> {
    ...
    C$$Anko$Factories$Sdk25ViewGroup$IMAGE_SWITCHER$1() {
        super(1);
    }
