...
public final class C$$Anko$Factories$Sdk25View {
    ...
    private static final Function1<Context, MediaRouteButton> MEDIA_ROUTE_BUTTON = null;
    ...
    private static final Function1<Context, TextClock> TEXT_CLOCK = null;
    ...
    private static final Function1<Context, TvView> TV_VIEW = null;
    ...
    private static final Function1<Context, WebView> WEB_VIEW = null;
    ...
    private C$$Anko$Factories$Sdk25View() {
        ...
        WEB_VIEW = C$$Anko$Factories$Sdk25View$WEB_VIEW$1.INSTANCE;
