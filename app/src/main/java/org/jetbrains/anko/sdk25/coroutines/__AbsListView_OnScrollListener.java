...
public final class __AbsListView_OnScrollListener implements AbsListView.OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView absListView, int i) {
        ...
        if (function4 != null) {
            BuildersKt.launch$default(this.context, (CoroutineStart) null, new __AbsListView_OnScrollListener$onScrollStateChanged$1(function4, absListView, i, (Continuation) null), 2, (Object) null);
        }
    }
    ...
    public void onScroll(AbsListView absListView, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            BuildersKt.launch$default(this.context, (CoroutineStart) null, new __AbsListView_OnScrollListener$onScroll$1(function6, absListView, i, i2, i3, (Continuation) null), 2, (Object) null);
        }
    }
