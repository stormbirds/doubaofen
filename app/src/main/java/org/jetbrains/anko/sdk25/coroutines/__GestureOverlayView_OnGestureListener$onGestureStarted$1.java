...
final class __GestureOverlayView_OnGestureListener$onGestureStarted$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        ...
        __GestureOverlayView_OnGestureListener$onGestureStarted$1 __gestureoverlayview_ongesturelistener_ongesturestarted_1 = new __GestureOverlayView_OnGestureListener$onGestureStarted$1(this.$handler, this.$overlay, this.$event, continuation);
        __gestureoverlayview_ongesturelistener_ongesturestarted_1.p$ = coroutineScope;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__GestureOverlayView_OnGestureListener$onGestureStarted$1) create(coroutineScope, continuation)).doResume(Unit.INSTANCE, (Throwable) null);
    }
