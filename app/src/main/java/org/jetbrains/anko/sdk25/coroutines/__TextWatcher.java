...
public final class __TextWatcher implements TextWatcher {
    ...
    public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            BuildersKt.launch$default(this.context, (CoroutineStart) null, new __TextWatcher$beforeTextChanged$1(function6, charSequence, i, i2, i3, (Continuation) null), 2, (Object) null);
        }
    }
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            BuildersKt.launch$default(this.context, (CoroutineStart) null, new __TextWatcher$onTextChanged$1(function6, charSequence, i, i2, i3, (Continuation) null), 2, (Object) null);
        }
    }
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (function3 != null) {
            BuildersKt.launch$default(this.context, (CoroutineStart) null, new __TextWatcher$afterTextChanged$1(function3, editable, (Continuation) null), 2, (Object) null);
        }
    }
