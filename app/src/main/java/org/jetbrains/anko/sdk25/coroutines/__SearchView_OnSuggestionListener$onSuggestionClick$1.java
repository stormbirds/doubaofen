...
final class __SearchView_OnSuggestionListener$onSuggestionClick$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        ...
        __SearchView_OnSuggestionListener$onSuggestionClick$1 __searchview_onsuggestionlistener_onsuggestionclick_1 = new __SearchView_OnSuggestionListener$onSuggestionClick$1(this.$handler, this.$position, continuation);
        __searchview_onsuggestionlistener_onsuggestionclick_1.p$ = coroutineScope;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__SearchView_OnSuggestionListener$onSuggestionClick$1) create(coroutineScope, continuation)).doResume(Unit.INSTANCE, (Throwable) null);
    }
