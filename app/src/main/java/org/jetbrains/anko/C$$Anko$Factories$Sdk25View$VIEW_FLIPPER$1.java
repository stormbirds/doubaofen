...
final class C$$Anko$Factories$Sdk25View$VIEW_FLIPPER$1 extends Lambda implements Function1<Context, ViewFlipper> {
    public static final C$$Anko$Factories$Sdk25View$VIEW_FLIPPER$1 INSTANCE = new C$$Anko$Factories$Sdk25View$VIEW_FLIPPER$1();

    C$$Anko$Factories$Sdk25View$VIEW_FLIPPER$1() {
        super(1);
    }
