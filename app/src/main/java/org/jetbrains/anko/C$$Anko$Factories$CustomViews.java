...
public final class C$$Anko$Factories$CustomViews {
    ...
    private static final Function1<Context, ProgressBar> HORIZONTAL_PROGRESS_BAR_FACTORY = null;
    public static final C$$Anko$Factories$CustomViews INSTANCE = null;
    private static final Function1<Context, _LinearLayout> VERTICAL_LAYOUT_FACTORY = null;
    ...
    private C$$Anko$Factories$CustomViews() {
        INSTANCE = this;
        VERTICAL_LAYOUT_FACTORY = C$$Anko$Factories$CustomViews$VERTICAL_LAYOUT_FACTORY$1.INSTANCE;
        EDIT_TEXT = C$$Anko$Factories$CustomViews$EDIT_TEXT$1.INSTANCE;
        HORIZONTAL_PROGRESS_BAR_FACTORY = C$$Anko$Factories$CustomViews$HORIZONTAL_PROGRESS_BAR_FACTORY$1.INSTANCE;
    }
