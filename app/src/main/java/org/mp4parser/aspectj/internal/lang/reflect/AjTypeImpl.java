...
public class AjTypeImpl<T> implements AjType<T> {
    ...
    private org.mp4parser.aspectj.lang.reflect.Pointcut asPointcut(java.lang.reflect.Method r9) {
        /*
            r8 = this;
        ...
        L_0x0034:
            ...
            org.mp4parser.aspectj.lang.reflect.AjType r6 = org.mp4parser.aspectj.lang.reflect.AjTypeSystem.getAjType(r2)
    ...
    private void addAnnotationStyleDeclareParents(List<org.mp4parser.aspectj.lang.reflect.DeclareParents> list) {
        for (Field field : this.clazz.getDeclaredFields()) {
    ...
    public DeclarePrecedence[] getDeclarePrecedence() {
        ...
        if (this.clazz.isAnnotationPresent(org.mp4parser.aspectj.lang.annotation.DeclarePrecedence.class)) {
            arrayList.add(new DeclarePrecedenceImpl(((org.mp4parser.aspectj.lang.annotation.DeclarePrecedence) this.clazz.getAnnotation(org.mp4parser.aspectj.lang.annotation.DeclarePrecedence.class)).value(), this));
        }
        for (Method method : this.clazz.getDeclaredMethods()) {
