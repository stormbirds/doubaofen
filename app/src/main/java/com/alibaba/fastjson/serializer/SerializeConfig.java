...
public class SerializeConfig extends IdentityHashMap<Type, ObjectSerializer> {
    ...
    public final ObjectSerializer createASMSerializer(Class<?> cls) throws Exception {
        return this.asmFactory.createJavaBeanSerializer(cls, (Map<String, String>) null);
    }
    ...
    public ObjectSerializer getObjectWriter(Class<?> cls) {
        ...
        if (Map.class.isAssignableFrom(cls)) {
            ...
            put(cls, new JavaBeanSerializer(cls, (Map<String, String>) null, TypeUtils.getSerializeFeatures(cls) | SerializerFeature.WriteClassName.mask));
