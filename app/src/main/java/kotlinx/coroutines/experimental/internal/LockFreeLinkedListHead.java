    ...
    public final void validate$kotlinx_coroutines_core() {
        ...
        if (next != null) {
            ...
            while (!Intrinsics.areEqual((Object) lockFreeLinkedListNode4, (Object) this)) {
                LockFreeLinkedListNode unwrap = LockFreeLinkedListKt.unwrap(lockFreeLinkedListNode4.getNext());
                lockFreeLinkedListNode4.validateNode$kotlinx_coroutines_core(lockFreeLinkedListNode3, unwrap);
                lockFreeLinkedListNode3 = lockFreeLinkedListNode4;
                lockFreeLinkedListNode4 = unwrap;
            }
