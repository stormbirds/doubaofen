...
public class NotificationCompat {
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            NotificationCompatJellybean.Builder builder4 = new NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            NotificationCompatKitKat.Builder builder4 = new NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            Builder builder2 = builder;
            NotificationCompatApi26.Builder builder3 = r1;
            NotificationCompatApi26.Builder builder4 = new NotificationCompatApi26.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder2.mChannelId, builder2.mBadgeIcon, builder2.mShortcutId, builder2.mTimeout, builder2.mColorized, builder2.mColorizedSet, builder.mGroupAlertBehavior);
            NotificationCompatApi26.Builder builder5 = builder3;
            NotificationCompat.addActionsToBuilder(builder5, builder2.mActions);
            if (builder2.mStyle != null) {
                builder2.mStyle.apply(builder5);
            }
