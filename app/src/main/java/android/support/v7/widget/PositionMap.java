...
class PositionMap<E> implements Cloneable {
    ...
    public void delete(int r4) {
        /*
            ...
            int[] r0 = r3.mKeys
            int r1 = r3.mSize
            int r4 = android.support.v7.widget.PositionMap.ContainerHelpers.binarySearch(r0, r1, r4)
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.PositionMap.delete(int):void");
    }
