...
public final class URandomKt {
    ...
    public static final int m848nextUIntqCasIEU(Random random, int i) {
        Intrinsics.checkParameterIsNotNull(random, "$this$nextUInt");
        return m847nextUInta8DCA5k(random, 0, i);
    }

    /* renamed from: nextUInt-a8DCA5k  reason: not valid java name */
    public static final int m847nextUInta8DCA5k(Random random, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$nextUInt");
        m842checkUIntRangeBoundsJ1ME1BU(i, i2);
    ...
    public static final int nextUInt(Random random, UIntRange uIntRange) {
        ...
        if (uIntRange.isEmpty()) {
            ...
            return m847nextUInta8DCA5k(random, uIntRange.getFirst(), UInt.m88constructorimpl(uIntRange.getLast() + 1));
        } else {
            if (UnsignedKt.uintCompare(uIntRange.getFirst(), 0) > 0) {
                return UInt.m88constructorimpl(m847nextUInta8DCA5k(random, UInt.m88constructorimpl(uIntRange.getFirst() - 1), uIntRange.getLast()) + 1);
            }
    ...
    public static final long m849nextULongV1Xi4fY(Random random, long j) {
        Intrinsics.checkParameterIsNotNull(random, "$this$nextULong");
        return m850nextULongjmpaWc(random, 0, j);
    }

    /* renamed from: nextULong-jmpaW-c  reason: not valid java name */
    public static final long m850nextULongjmpaWc(Random random, long j, long j2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$nextULong");
        m843checkULongRangeBoundseb3DHEI(j, j2);
    ...
    public static final long nextULong(Random random, ULongRange uLongRange) {
        ...
        if (uLongRange.isEmpty()) {
            ...
            return m850nextULongjmpaWc(random, uLongRange.getFirst(), ULong.m157constructorimpl(uLongRange.getLast() + ULong.m157constructorimpl(((long) 1) & 4294967295L)));
        } else {
            if (UnsignedKt.ulongCompare(uLongRange.getFirst(), 0) <= 0) {
                return nextULong(random);
            }
            long j = ((long) 1) & 4294967295L;
            return ULong.m157constructorimpl(m850nextULongjmpaWc(random, ULong.m157constructorimpl(uLongRange.getFirst() - ULong.m157constructorimpl(j)), uLongRange.getLast()) + ULong.m157constructorimpl(j));
        }
    }

    /* renamed from: nextUBytes-EVgfTAA  reason: not valid java name */
    public static final byte[] m844nextUBytesEVgfTAA(Random random, byte[] bArr) {
    ...
    public static final byte[] m845nextUBytesWvrt4B4(Random random, byte[] bArr, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$nextUBytes");
        Intrinsics.checkParameterIsNotNull(bArr, "array");
    ...
    public static final void m842checkUIntRangeBoundsJ1ME1BU(int i, int i2) {
    ...
    public static final void m843checkULongRangeBoundseb3DHEI(long j, long j2) {
