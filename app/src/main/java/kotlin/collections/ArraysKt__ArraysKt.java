    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m407contentToStringGBYM_sE(((UByteArray) t).m79unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m409contentToStringrL5Bavg(((UShortArray) t).m284unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m406contentToStringajY9A(((UIntArray) t).m148unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m408contentToStringQwZRm1k(((ULongArray) t).m217unboximpl()));
            } else {
