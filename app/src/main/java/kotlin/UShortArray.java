...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static short[] m270constructorimpl(short[] sArr) {
    ...
    public static final boolean m274equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static boolean m272containsAllimpl(short[] sArr, Collection<UShort> collection) {
        boolean z;
