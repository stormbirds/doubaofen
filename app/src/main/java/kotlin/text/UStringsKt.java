...
public final class UStringsKt {
    ...
    public static final String m890toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m892toStringolVBNx4(short s, int i) {
    ...
    public static final String m891toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m889toStringJSWoG40(long j, int i) {
