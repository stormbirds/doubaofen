...
public final class UInt implements Comparable<UInt> {
    ...
    private static final int m90div7apg3OU(int i, byte b) {
        return UnsignedKt.m286uintDivideJ1ME1BU(i, m88constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final int m109rem7apg3OU(int i, byte b) {
        return UnsignedKt.m287uintRemainderJ1ME1BU(i, m88constructorimpl(b & UByte.MAX_VALUE));
    }
